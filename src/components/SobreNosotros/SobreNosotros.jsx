  ...
  return (
    <section className="sobre-nosotros">
      ...
      <p>
        ...
        & Donas nació como un emprendimiento hecho con amor, dedicación y
        muchísimas ganas de llevar a sus mesas algo rico para compartir. Cada
        producto está pensado para acompañar momentos simples, esos que valen la
